...
<html>
    ...
    <div class="l-sidebar">
      ...
      <div class="l-sidebar__content">
        <nav class="c-menu js-menu">
          <ul class="u-list">
            <li class="c-menu__item is-active" data-toggle="tooltip" title="Saved Products">
            ...
            <li class="c-menu__item" data-toggle="tooltip" title="All Products">
              <a href="all_products.php">
                    <div class="c-menu__item__inner"><i class="fa fa-calendar" aria-hidden="true"></i>
                    <div class="c-menu-item__title"><span>All Products</span></div>
                    </div>
              </a>
            </li>
           
            <li class="c-menu__item has-submenu" data-toggle="tooltip" title="Farmers">
              <a href="all_farmers.php">
                    <div class="c-menu__item__inner"><i class="fa fa-users" aria-hidden="true"></i>
                    <div class="c-menu-item__title"><span>Farmers</span></div>
                    </div>
              </a>
            </li>
  ...
  <main class="l-main">
    <div class="content-wrapper content-wrapper--with-bg">
      <h1 class="page-title" style="color:chartreuse;">User Dashboard</h1>
      <div class="page-content">Welcome back <em style="font-size: 22px; color: chartreuse;"><?php echo ucfirst($row['user_name']);?>!</em></div>
            ...
            <div class="row mt-4 mb-4">
                <div class="col-md-3">
                  ...
                  <i class="fa fa-calendar" aria-hidden="true"></i>
                    ...
                    <span class="count-name">Ordered Products</span>
                  </div>
                </div>
