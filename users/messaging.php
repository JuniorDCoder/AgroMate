    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="users">
                        <h2>All  &nbsp;<i class="fa fa-buysellads text-dark fs-2 align-middle"></i> groMate Farmers</h2>
                        <ul class="list-group">
                            <?php
                            if (isset($_SESSION['user_unique_id'])) {
                              ...
                              $result = $farmers->getAllExistingFarmers();
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo '<a href="messaging.php?receiverId='.$row['unique_id'].'&senderId='.$sender_Id.'">'.$row['farmer_name'].': ('.$row['farmer_email'].')</a><br>';
                                }
             ...
             if (isset($messages)) {
                foreach ($messages as $message) {
                    if ($message['sender_id'] == $senderId) {
                      ...
                      echo '</div>';
                      echo '<h6><img src="public/userProfileImages/work-1.png" width="60" height="60" class="rounded-image1" alt="abc"></h6>';
                      echo '</div>';
                    } else {
                      
                      echo '<div class="message-row left">';
                      echo '<h6><img src="public/userProfileImages/work-1.png" width="60" height="60" class="rounded-image" alt="abc"></h6>';
        ...
        $(function() {
            ...
            $.get('messaging.php?receiverId=<?php echo $receiverId; ?>&lastMessageId=' + lastMessageId, function(data) {
                ...
                var html = '';
                if (message.sender_id == '<?php echo $sender_Id; ?>') {
