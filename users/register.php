...
<body>
    <form class="box" action="includes/signup.inc.php" method="POST">
        <h1>Register</h1>
        <input type="text" id="username" placeholder="Enter your name" name="user_name" required>
        <input type="text" id="username" placeholder="Enter your Email" name="user_email" required>
        <input type="text" id="username" placeholder="Enter your Address" name="user_address" required>
        <input type="password" id="password" placeholder="Enter your password" name="user_password" required>
        <input type="text" id="phonenumber" placeholder="Enter your phone"  name="user_phone" required>
        <?php
                if(isset($_GET['error'])){
                    if($_GET['error']=="email"){
                        ...
                        echo '<p id="info-message">User Exist With These Credentials!!</p>';
                    }
