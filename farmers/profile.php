...
<body>
    ...
    <?php
        ...
        $rating = new Ratings;
        $rate = $rating->getAverageRating($_SESSION['farmer_id']);
    ?>
            ...
            <div class="row  w-auto">
                <div class="col md-3 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                            ...
                            <img class="rounded-circle mt-5" width="150px" src="public/farmerProfileImages/<?php echo $row['profile_picture']; ?>">
                            
                            <input type="file" name="farmer_image"><br>
                            
                            <span class="font-weight-bold mb-1" style="color: blue;"><?php echo 'Average Rating: '. round($rate).' /5 stars'; ?></span>
                            <span class="font-weight-bold"><?php echo $row['farmer_name']; ?></span>
                            <span style="color:black;font-size:22px;"><em><?php echo $row['farmer_email']; ?></em></span></div>
                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-3">
                            <div class="col md-12"><label class="labels">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mobile Number</label>
                                <input name="farmer_phone"  type="text" class="form-control" value="<?php echo $row['farmer_phone']; ?>">
                            </div>
                            <div class="col md-12"><label class="labels">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Address</label>
                                <input name="farmer_address" type="text" class="form-control" value="<?php echo $row['farmer_address']; ?>">
                            </div>
